...
def main(args):
    ...
    args_dict['do_range_narrow' ] = False
    args_dict['do_range_full'   ] = True
    args_dict['do_threshold'    ] = np.array([[.9,True],[.8,False],[.7,False]])
    args_dict['input_file'      ] = 'input/ralf_hadsim/dw23_vs_wness_list.txt'
