#include <string>
void eta_dw23_fit(
    const std::string bkg_had_infilename = "/direct/phenix+scratch/danielj/run13analysis_output/physdisthists/run12_data_combined_tree.root",
    const std::string sig_w_infilename = "/direct/phenix+scratch/danielj/run13analysis_output/physdisthists/run12_data_combined_tree.root",
