  ...
  for(int source=0; source < 11; source++) {
    for(int arm=0; arm<n_arms; arm++) {
      for(int charge=0; charge<2; charge++) {
        ...
        for(int rpcdca_condition=0; rpcdca_condition<4; rpcdca_condition++) {
          for(int goodfvtx=0; goodfvtx<2; goodfvtx++) {
            ...
            if(source==0) {
              ...
              h_sbg_fit_eta[source][arm][charge][rpcdca_condition][goodfvtx] = new TH1F(histname,histname,100,1.1,2.6);
              ...
              h_sbg_fit_dw23[source][arm][charge][rpcdca_condition][goodfvtx] = new TH1F(histname,histname,100,-.1,.1);
              h_sbg_fit_dw23[source][arm][charge][rpcdca_condition][goodfvtx]->Sumw2();
            }else if(source==1) {
              sprintf(histname,"h_sbg_fit_eta_source%d_arm%d_charge%d_rpcdca%d_fvtx%d",source,arm,charge,rpcdca_condition,goodfvtx);
              h_sbg_fit_eta[source][arm][charge][rpcdca_condition][goodfvtx] = new TH1F(histname,histname,300,1.1,2.6);
              h_sbg_fit_eta[source][arm][charge][rpcdca_condition][goodfvtx]->Sumw2();

              sprintf(histname,"h_sbg_fit_dw23_source%d_arm%d_charge%d_rpcdca%d_fvtx%d",source,arm,charge,rpcdca_condition,goodfvtx);
              h_sbg_fit_dw23[source][arm][charge][rpcdca_condition][goodfvtx] = new TH1F(histname,histname,300,-.1,.1);
              h_sbg_fit_dw23[source][arm][charge][rpcdca_condition][goodfvtx]->Sumw2();
            } else {
              ...
              h_sbg_fit_eta[source][arm][charge][rpcdca_condition][goodfvtx] = new TH1F(histname,histname,60,1.1,2.6);
              h_sbg_fit_eta[source][arm][charge][rpcdca_condition][goodfvtx]->Sumw2();
              ...
              h_sbg_fit_dw23[source][arm][charge][rpcdca_condition][goodfvtx] = new TH1F(histname,histname,30,-.1,.1);
              h_sbg_fit_dw23[source][arm][charge][rpcdca_condition][goodfvtx]->Sumw2();
            }
          }
        }
        ...
        h2_dw23_vs_wness[source][arm][charge] = new TH2F(histname,histname,nhistbins_2dwness,.1,.9,nhistbins_2ddw23,distmin[11],distmax[11]);
        ...
        for(int wness_section=0; wness_section<10; wness_section++) {
          ...
          h2_dw23_vs_eta[source][arm][charge][wness_section] = new TH2F(histname,histname,nhistbins_2ddw23,distmin[3],distmax[3],nhistbins_2ddw23,distmin[11],distmax[11]);
          
          sprintf(histname,"h_dw23_source%d_arm%d_charge%d_wnesscut%d",source,arm,charge,wness_section);
          h_dw23[source][arm][charge][wness_section] = new TH1F(histname,histname,nhistbins_2ddw23,distmin[11],distmax[11]);
          ...
          h_eta[source][arm][charge][wness_section] = new TH1F(histname,histname,nhistbins_2ddw23,distmin[3],distmax[3]);
        }
      }
    }
  }
