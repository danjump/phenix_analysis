...
void run_totaltrig_dw23_extrapolation() {
  char * code_dir = "/direct/phenix+u/workarea/danielj/cvs_code/offline/analysis/danielj/run13_analysis/dw23_extrapolation";
  char lib_file[300];
  sprintf(lib_file,"%s/install/lib/libdw23_extrapolation.so",code_dir);
