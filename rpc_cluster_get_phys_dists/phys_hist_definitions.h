...
const int n_dists = 32;    //distributions
...
void define_basic_tree() {
  ...
  basic_cuts_tree->Branch("rpc_awayclusters3", &temp_int, "rpc_awayclusters3/I");
...
void define_wness_tree() {
  ...
  wness_tree->Branch("rpc_awayclusters3", &temp_int, "rpc_awayclusters3/I");
