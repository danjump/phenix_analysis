...
logdir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13_sim_zjet/logs"
mkdir -p $logdir
histdir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13_sim_zjet/hists"
mkdir -p $histdir
treedir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13_sim_zjet/trees"
mkdir -p $treedir
