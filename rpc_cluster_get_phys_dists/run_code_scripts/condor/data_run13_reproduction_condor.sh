...
logdir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13datarp/logs"
mkdir -p $logdir
histdir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13datarp/hists"
mkdir -p $histdir
treedir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13datarp/trees"
mkdir -p $treedir
