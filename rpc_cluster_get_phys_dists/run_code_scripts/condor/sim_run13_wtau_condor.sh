...
logdir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13_sim_wtau/logs"
mkdir -p $logdir
histdir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13_sim_wtau/hists"
mkdir -p $histdir
treedir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13_sim_wtau/trees"
mkdir -p $treedir
