...
logdir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13_sim_light/logs"
mkdir -p $logdir
histdir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13_sim_light/hists"
mkdir -p $histdir
treedir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13_sim_light/trees"
mkdir -p $treedir
