...
logdir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13_sim_z/logs"
mkdir -p $logdir
histdir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13_sim_z/hists"
mkdir -p $histdir
treedir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13_sim_z/trees"
mkdir -p $treedir
