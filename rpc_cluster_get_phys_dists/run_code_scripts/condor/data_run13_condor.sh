...
filelist="${base_dir}/filelists/filelist_run13pp510_data.txt"
logdir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13data/logs"
mkdir -p $logdir
histdir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13data/hists"
mkdir -p $histdir
treedir="/direct/phenix+scratch/danielj/condor/rpc_cluster_get_phys_dists/run13data/trees"
mkdir -p $treedir
