...
logdir="/direct/phenix+scratch/danielj/condor/get_phys_dists/run13data/logs"
mkdir -p $logdir
histdir="/direct/phenix+scratch/danielj/condor/get_phys_dists/run13data/hists"
mkdir -p $histdir
treedir="/direct/phenix+scratch/danielj/condor/get_phys_dists/run13data/trees"
mkdir -p $treedir
