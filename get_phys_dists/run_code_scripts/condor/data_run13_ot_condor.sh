...
logdir="/direct/phenix+scratch/danielj/condor/get_phys_dists/run13dataot/logs"
mkdir -p $logdir
histdir="/direct/phenix+scratch/danielj/condor/get_phys_dists/run13dataot/hists"
mkdir -p $histdir
treedir="/direct/phenix+scratch/danielj/condor/get_phys_dists/run13dataot/trees"
mkdir -p $treedir
