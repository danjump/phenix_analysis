...
logdir="/direct/phenix+scratch/danielj/condor/get_phys_dists/run13_sim_opencharm/logs"
mkdir -p $logdir
histdir="/direct/phenix+scratch/danielj/condor/get_phys_dists/run13_sim_opencharm/hists"
mkdir -p $histdir
treedir="/direct/phenix+scratch/danielj/condor/get_phys_dists/run13_sim_opencharm/trees"
mkdir -p $treedir
