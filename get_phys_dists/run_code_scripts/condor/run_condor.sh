...
logdir="/direct/phenix+scratch/danielj/condor/get_phys_dists/sim368630/logs"
mkdir -p $logdir
histdir="/direct/phenix+scratch/danielj/condor/get_phys_dists/sim368630/hists"
mkdir -p $histdir
treedir="/direct/phenix+scratch/danielj/condor/get_phys_dists/sim368630/trees"
mkdir -p $treedir
