...
void merge_other_triggers_rpccluster(const std::string normal_tree_filename, const std::string other_tree_filename, const std::string treeoutfilename) {
  ...
  normal_tree->SetBranchAddress("rpc_awayclusters3",&rpc_awayclusters3);
  ...
  other_tree->SetBranchAddress("rpc_awayclusters3",&rpc_awayclusters3);
